...
(library Library_1
	...
	(patternDef "2SCR514RTL" (originalName "2SCR514RTL")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.45 -0.825) (pt 1.45 -0.825) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.45 -0.825) (pt 1.45 0.825) (width 0.025))
		)
	...
	(compDef "2SCR514RTL" (originalName "2SCR514RTL") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "<Hyperlink>" "https://fscdn.rohm.com/en/products/databook/datasheet/discrete/transistor/bipolar/2scr514rtl-e.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "2SCR514RTL.stp")
