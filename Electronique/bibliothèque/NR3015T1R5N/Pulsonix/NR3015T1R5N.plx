...
(library Library_1
	...
	(patternDef "NR3015" (originalName "NR3015")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.297, 0.051) (textStyleRef "Normal") (isVisible True))
		)
	...
	(compDef "NR3015T1R5N" (originalName "NR3015T1R5N") (compHeader (numPins 2) (numParts 1) (refDesPrefix L)
		...
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-DGA11/2187054.pdf")
	)
